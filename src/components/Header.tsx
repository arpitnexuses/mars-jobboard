        ...
        <div className="flex items-center justify-between h-28">
          <div className="flex items-center">
            <Link href="/" className="flex items-center group">
              <div className="relative w-20 h-20 sm:w-32 sm:h-32 mr-2 sm:mr-6 transition-all duration-300 group-hover:scale-105 group-hover:rotate-3">
            ...
            {isLoggedIn ? (
              <>
                ...
                >
                  ...
                  <LogOut className="h-5 w-5 mr-2 relative" />
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-red-400/0 via-red-400/20 to-red-400/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <Upload className="h-5 w-5 mr-2 relative" />
                <span className="relative">Drop Your Resume</span>
              </Link>
            )}
          </div>
        </div>
